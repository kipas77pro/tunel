...
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/kipas77pro/tunel/main/tools/vnstat.sh && chmod +x vnstat.sh && ./vnstat.sh
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[42;1;37m          >>> Install SSH / WS <<<        \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/kipas77pro/tunel/main/ssh/ssh-vpn8.sh && chmod +x ssh-vpn8.sh && ./ssh-vpn8.sh
echo -e "┌─────────────────────────────────────────┐"
...
wget -q https://raw.githubusercontent.com/kipas77pro/tunel/main/wsoket/sshws.sh && chmod +x sshws.sh && ./sshws.sh
#echo -e "┌─────────────────────────────────────────┐"
...
wget -q -O /usr/bin/update-xray "https://raw.githubusercontent.com/kipas77pro/tunel/main/tools/update-xray.sh"
